...
const Payment = ({ cart, setCart, isLoggedIn }) => {
  ...
  const handlePayment = async (e) => {
    ...
    try {
      ...
      // Try to save order to backend if logged in (for future implementation)
      if (token) {
        try {
          console.log('Order will be synced to backend in future implementation');
